...
TicketControl.prototype.sendPrintTicket = new CronJob('*/5 * * * * *', function () {
        log.info('#########出票######### 出票任务');
        async.waterfall([function (cb) {
           /**
            ...
            var array = new Array();
            var index = 100;
            if (gameCode == 'T05' || gameCode == 'T06' || gameCode == 'T51' )  {
                index = 10;
            };
...
TicketControl.prototype.dealPrintWaitTickets = new CronJob('0 */2 * * * *', function () {
        ...
        async.waterfall([function (cb) {
            ...
            //暂定2分钟 2*60*1000
            if (nowTime - ticket.takeTime > 120000) {
                //查询到所属终端机,发送查询请求
