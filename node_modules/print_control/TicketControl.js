            ...
            for (var i = 0; i < tickets.length; i++) {
                ...
                if (nodePlatCons.mode == 'test') {
                    if (tickets[i].gameCode == 'T53') {
                        ...
                        ticket.namedata =  moment().add(20, 'minute').format('YYMMDDHHmmss') + '-' + tickets[i].id + '-' + terminalDataUtil.gameCodeTrans[tickets[i].gameCode].code + '-' + terminalDataUtil.gameCodeTrans[tickets[i].gameCode].playType[tickets[i].playTypeCode + tickets[i].betTypeCode].tCode + '-'+tickets[i].termCode+'-' + tickets[i].amount;
                        console.log(ticket.namedata);
                    } else if (tickets[i].gameCode == 'T51') {
                        //竞彩
                        ticket.namedata = moment().add(1, 'days').format('YYMMDDHHmmss') + '-' + tickets[i].id + '-' + terminalDataUtil.jcPlayTypeCodeTrans[tickets[i].gameCode][tickets[i].playTypeCode] + '-' + terminalDataUtil.gameCodeTrans[tickets[i].gameCode].tCode + '-' + tickets[i].termCode + '-' + tickets[i].amount;
                    } else {
                ...
                if (tickets[i].gameCode == 'T53' || tickets[i].gameCode == 'T54' || tickets[i].gameCode == 'T55') {
                    ...
                    ticket.data = terminalDataUtil.transNumbers(tickets[i].gameCode, tickets[i].playTypeCode, tickets[i].betTypeCode, tickets[i].multiple) + numbers.split('@')[0] + '\n';
                }
