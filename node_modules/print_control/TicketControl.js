            ...
            for (var i = 0; i < tickets.length; i++) {
                ...
                if (nodePlatCons.mode == 'test') {
                    if (tickets[i].gameCode == 'T53') {
                        ...
                        ticket.namedata =  moment().add(10, 'minute').format('YYMMDDHHmmss') + '-' + tickets[i].id + '-' + terminalDataUtil.gameCodeTrans[tickets[i].gameCode].code + '-' + terminalDataUtil.gameCodeTrans[tickets[i].gameCode].playType[tickets[i].playTypeCode + tickets[i].betTypeCode].tCode + '-'+tickets[i].termCode+'-' + tickets[i].amount;
