            ...
            for (var i = 0; i < tickets.length; i++) {
                ...
                if (nodePlatCons.mode == 'test') {
                    if (tickets[i].gameCode == 'T53') {
                        ...
                        log.error(ticket.closeTime);
                        log.error(moment(ticket.closeTime).format('YYMMDDHHmmss'));
                        ticket.namedata =  moment(ticket.closeTime).format('YYMMDDHHmmss') + '-' + tickets[i].id + '-' + terminalDataUtil.gameCodeTrans[tickets[i].gameCode].code + '-' + terminalDataUtil.gameCodeTrans[tickets[i].gameCode].playType[tickets[i].playTypeCode + tickets[i].betTypeCode].tCode + '-'+tickets[i].termCode+'-' + tickets[i].amount;
                        console.log(ticket.namedata);
                    } else if (tickets[i].gameCode == 'T51') {
                        //竞彩
                        ticket.namedata = moment(ticket.closeTime).format('YYMMDDHHmmss') + '-' + tickets[i].id + '-' + terminalDataUtil.jcPlayTypeCodeTrans[tickets[i].gameCode][tickets[i].playTypeCode] + '-' + terminalDataUtil.gameCodeTrans[tickets[i].gameCode].tCode + '-' + tickets[i].termCode + '-' + tickets[i].amount;
                    } else {
                        ticket.namedata = moment(ticket.closeTime).format('YYMMDDHHmmss') + '-' + tickets[i].id + '-' + terminalDataUtil.gameCodeTrans[tickets[i].gameCode].code + '-' + terminalDataUtil.gameCodeTrans[tickets[i].gameCode].playType[tickets[i].playTypeCode + tickets[i].betTypeCode].tCode + '-05005-' + tickets[i].amount;
                    }
                }
