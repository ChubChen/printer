                            ...
                            try {
                                ...
                                if (flag) {
                                    mongoDBUtil.db.collection('TerminalPrintSuccess', {safe: true}, function (err, collection) {
										...
										//推送状态
										//var body = {
											//ticketId : result['outerId'],
											//ticketStatus : '2'   //出票成功
										//}
										//nodePlatAssist.updateTicketStatus(body,function (err, backMsgNode) {
											//if(err){
												// log.info("票状态修改异常");
											//}else{
...
TerminalControl.prototype.handle0071 = function (headNode, bodyNode) {
    ...
    mongoDBUtil.db.collection('TicketsWaitBonus', {
        ...
        for (var i = 0; i < arr.length; i++) {
            ...
            if (_bonusInfo.indexOf('奖期不在可兑奖状态') >= 0 || _bonusInfo.indexOf('未开奖') >= 0) { //不在兑奖时间内
