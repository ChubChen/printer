...
//刷新额度
SocketControl.prototype.refeshAmount = function (bodyNode, cb) {
    collection.findOne({ 'id': bodyNode.terminalId}, function (err, result) {
        var backNode = {
            cmd: '0008',
            sequenceId: uuid.v4().replace(/\-/g, ''),
            terminalId: bodyNode.terminalId
        }
...
SocketControl.prototype.editConfig = function(bodyNode, cb){
    log.info("修改延迟时间配置信息");
    log.info(bodyNode);
