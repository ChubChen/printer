      ...
      var index = 2;
        ...
        for (var i = 0; i < tickets.length; i++) {
            ...
            if (tickets[i].gameCode == 'T53') {
                ...
                //扫描口
                ticket.namedata = moment(tickets[i].auditTime).format('YYMMDDHHmmss') + '-' + tickets[i].id + '-' + terminalDataUtil.jcPlayTypeCodeTrans[tickets[i].gameCode][tickets[i].playTypeCode] + '-' + terminalDataUtil.gameCodeTrans[tickets[i].gameCode + 'SM'].tCode + '-' + tickets[i].termCode + '-' + tickets[i].amount;

            } else if (tickets[i].gameCode == 'T52') {
                //竞彩篮球
                ticket.namedata = moment(tickets[i].auditTime).format('YYMMDDHHmmss') + '-' + tickets[i].id + '-' + terminalDataUtil.jcPlayTypeCodeTrans[tickets[i].gameCode][tickets[i].playTypeCode] + '-' + terminalDataUtil.gameCodeTrans[tickets[i].gameCode].tCode + '-' + tickets[i].termCode + '-' + tickets[i].amount;
            } else {
            ...
            if (tickets[i].gameCode == 'T53' || tickets[i].gameCode == 'T54' || tickets[i].gameCode == 'T55') {
                ...
                //扫描
                ticket.data = scnaDataTrans.jcScanNumberTrans(tickets[i]);
