...
ScanDateTrans.prototype.jcScanNumberTrans = function (ticket) {
    ...
    //组装
    var str = pTypePaper[ticket.gameCode + ticket.playTypeCode + ticket.betTypeCode.substr(0, 1)];
    if(!str){
        return null;
    }
    ...
    for(var i= 0; i< tempLen; i++){
        ...
        else if (ticket.playTypeCode == "03") {//半全场
...
var pTypePaper = {
    'T51021': '01 1c 00 0d 00 0e 00 31 07 ',
    'T51022': '01 1c 00 0d 00 0e 00 31 07 ',
    'T51023': '01 1c 00 0d 00 0e 00 31 07 ',


    'T51024': '01 2c 00 0d 00 16 00 3a 0b ',
    'T51025': '01 2c 00 0d 00 16 00 3a 0b ',
    'T51026': '01 2c 00 0d 00 16 00 3a 0b ',

    'T51027': '01 3c 00 0d 00 1e 00 50 0f ',
    'T51028': '01 3c 00 0d 00 1e 00 50 0f ',
    //半全场
    'T51051': '01 20 00 0d 00 10 00 32 08 ',
    'T51052': '01 20 00 0d 00 10 00 32 08 ',
    'T51053': '01 20 00 0d 00 10 00 32 08 '
};
