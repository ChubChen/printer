...
HttpUtil.prototype.sendBouns2NodePlat = function (body,cb) {
    ...
    var cpId = body.outerId;
    var preBouns = body.preBouns;
    var aftBouns = body.aftBouns;
    //log.info("cpId="+cpId + "-----preBouns="+ preBouns +"-----aftBouns"+aftBouns);
    var opt = {
        hostname: '10.16.1.13',
        port: 9010,
        path: '/out/sendTicketLogic.do?logicNum=105&cpId='+ cpId + '&preBouns='+preBouns + '&aftBouns='+ aftBouns,
        method: 'POST'
    }
