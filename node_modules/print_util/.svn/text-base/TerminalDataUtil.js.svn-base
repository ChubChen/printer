...
TerminalDataUtil.prototype.numberTrans = function (gameCode, playTypeCode, betTypeCode, number) {
    ...
    if (gameCode == 'T05') {
        ...
        for (var i = 0; i < arr.length; i++) {
            ...
            var wan;
            //xiugai
            var temp = date + index + ' ' + num.split("@")[0] + ' /\n';
            ...
            if (playTypeCode == '06') {
                ...
                temp = date + index + ' ' + wan + ' ' + num.split("@")[0] + ' /\n';
...
TerminalDataUtil.prototype.transNumbers = function (gameCode, ptc, btc, multiple) {
    ...
    switch (gameCode) {
        ...
        case 'F01':
            ...
            result = self.gameCodeTrans[gameCode].playType[playTypeBetType].tKeyboard + 'D:' + multiple + '\n';
            break;
    }
    return result;
};
...
TerminalDataUtil.prototype.jcPlayTypeCodeTrans = {
    'T51': {
        '01': '56',
        '02': '51',
        '03': '52',
